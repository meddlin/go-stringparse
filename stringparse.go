...
/*
	CPAT CLI commands
	Main CRUD commands
	- Company: create, read/retrieve, update, delete
	- Device: create, read/retrieve, update, delete
	- Location: create, read/retrieve, update, delete
	- Person: create, read/retrieve, update, delete
	- Target: create, read/retrieve, update, delete

	- project/campaign: create, select, list all, delete
	- file: send to CPAT store, auto-relates to chosen project/campaign
	- list scripts: lists the pre-defined OSINT scripts available to a user

	Command
	--create [type] --parent [object id]
